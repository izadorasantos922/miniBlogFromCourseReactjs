...
const Register = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
        <label>
            <span>Nome:</span>
            <input type="text" name="displayName" id="" required placeholder='Nome do usuário' value={displayName} onChange={(e) => setDisplayName(e.target.value)}/>
        </label>
        <label>
            <span>Email:</span>
        ...
        <label>
            ...
            <input type="password" name="confirmPassword" id="" required placeholder='Confirmar senha' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
        </label>
